...
@Component({
  ...
  styleUrl: './party-name.component.scss'
})
export class PartyNameComponent {
  courtComplexes = ['Complex A', 'Complex B', 'Complex C'];
  caseTypes = [
  ...
  onSubmit(form: any): void {
    if (this.validateCaptcha(form.value.captcha)) {
      this.queryParams = { ...this.queryParams, caseType: form.value.caseType,
        petitionerOrRespondentName:form.value.petitionerOrRespondent };
